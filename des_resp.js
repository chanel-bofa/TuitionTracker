...
var des_resp_dict = {
			'SQA Tester': ["Provide input on the development of test plans, scenarios, and test cases"+ "<br/>",
					"- Execute test plans and identify, record, and report bugs and issues in a timely manner" + "<br/>"
					+ "- Communicate test progress, test results, and other relevant information to project stakeholders" + "<br/>"
					+ "- Develop an understanding of the application and project goals to design script and execute manula and automated software testing" + "<br/>"
						],
			'SQA Lead': ["Manages contractors and consultants, and oversees the development, maintenance, enhancement, and execution of software QA artifacts within a line of business or technology function",
			 			"- Assess and evaluate risk from a timing and priority perspective" + "<br/>"
						+ "- Knowledge of the budget(e.g. delivering within budget)" + "<br/>" 
						+ "- Exercise agility in adapting to changes in scope" + "<br/>"
						+ "- Captain on the Field, directing the activities of a team and providing \"\" " + "<br/>"
						+ "- Work with business partners, vendors, operations, and technology to ensure that applications are developed properly and ready for deployment" + "<br/>"
			 			],
			"SQA Senior Lead": ["Manages Contractors and consultants, and works with business partners, vendors, operations, and technology to ensure that applications are developed properly and ready for deployment",
						"- Apply strategic thinking to complex, large-scale projects " + "<br/>"
						+ "- Exercise agility in adapting to changes in scope" + "<br/>"
						+ "- Captain on the Field, directing the activities of a large QA team or several teams and providing \"on the spot\" coaching and mentoring on QA testing techniques" + "<br/>"
						],
			"SQA Manager": ["Manages and influences a team of employees toward a common goal and/or deliverable"+ "<br/>",
						"- Develop employees through regular performance management and coaching routines" + "<br/>"
						+ "- Drive QA metrics and dashboards" + "<br/>"
						],
			"SQA Senior Manager": [ "Develop employees through regular performance management and coaching routines, and drives QA metrics and dashboards",
						"- Exercise agility in adapting to changing scope, budget, etc." + "<br/>"
						+ "- Serve as a role model in fostering an inclusive, client-centric team environment aligned to our guiding principles and strategic priorities" + "<br/>"
						+ "- Structure, motivate, and influence multiple teams" + "<br/>"
						],
